        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="w-20 h-20 mx-auto mb-6 bg-gray-800/80 backdrop-blur-sm rounded-full flex items-center justify-center border border-gray-700">
              <WarningIcon className="text-yellow-400 w-10 h-10" />
            </div>
            <h1 className="text-2xl font-bold text-white mb-4">
              Security Warning
            </h1>
            <p className="text-gray-300 text-base">
              Anyone who has this mnemonic will have complete access to any
          ...
          <div className="space-y-6">
            <div
              ...
              onClick={() => {
                console.log(
                  "Checkbox container clicked, current value:",
                  warnChecked
                );
            ...
            <Button
              ...
              onClick={() => {
                console.log(
                  "Continue button clicked, warnChecked:",
                  warnChecked
                );
                onContinue();
              }}
